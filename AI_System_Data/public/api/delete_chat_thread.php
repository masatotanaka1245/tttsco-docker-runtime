...
if (!$projectId || !$threadId) {
    ...
    echo json_encode(['success' => false, 'error' => '案件IDまたはスレッドIDの形式が不正です'], JSON_UNESCAPED_UNICODE);
    exit;
}
...
try {
    $result = ChatThreadManager::deleteThread($pdo, (int)$projectId, (int)$threadId, (int)$_SESSION['user_id']);
    echo json_encode([
        'success' => true,
        'counts' => $result['counts'],
        'fallback_thread_id' => $result['fallback_thread_id'],
