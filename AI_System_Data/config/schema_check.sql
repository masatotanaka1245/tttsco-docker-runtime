...
('doc_chunks', 4, 'chunk_summary', 'text', 'YES'),
('doc_chunks', 5, 'embedding', 'json', 'NO'),
('doc_chunks', 6, 'image_description', 'text', 'YES'),
('doc_chunks', 7, 'page_number', 'int', 'YES'),
('doc_chunks', 8, 'created_at', 'datetime', 'YES'),
