...
| --- | --- | --- | --- | --- |
| P1 | 進行中 | CSV の曖昧質問を、誤った概況回答ではなく確認質問へ倒す境界を整える | `AI_System_Data/src/CsvAggregationPlanner.php`, `AI_System_Data/src/CsvAggregationAnswerFormatter.php`, `AI_System_Data/public/api/chat_analysis.php` | 列未指定の `グラフ化してください` で確認質問に止まることを確認する |
